...
AUTHORIZATION_RECEIPT = {'X-Auth': '{}:{}'.format(settings.PAYME_SETTINGS['KASSA_ID'],settings.PAYME_SETTINGS['SECRET_KEY'])}
AUTHORIZATION_CREATE = {'X-Auth': '{}'.format(settings.PAYME_SETTINGS['KASSA_ID'])}
